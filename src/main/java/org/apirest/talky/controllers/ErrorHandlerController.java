...
public class ErrorHandlerController {
    ...
    private ResponseEntity <Map<String, Object>> handleException (IllegalArgumentException ex) {
    ...
    private ResponseEntity <Map<String, Object>> titleNotValidException (TitleNotValidException ex) {
        final var response = new HashMap<String, Object>();
